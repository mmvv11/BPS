...
def parse_arguments():
    ...
    # model args
    parser.add_argument("-l2", "--l2", type=float, default=1e-3, help="weight decay of embeddings")
    ...
    parser.add_argument("-act", "--activation", type=str, default="tf.nn.leaky_relu",
                        choices=['tf.nn.relu', 'tf.nn.tanh', "tf.nn.leaky_relu"])
    parser.add_argument("-emb", "--embedded_dimension", type=str, default='[128, 64, 64]')
                      # [128, 128, 128]
    ...
    parser.add_argument("-ndrop", "--neighbor_dropout", type=float, default=0.2)
    ...
    # training args
    parser.add_argument("-b", "--batch_pairs", type=int, default=2048,
                        help='the size of a mini-batch of positive pairs')
                        #5000
    parser.add_argument("-b_eval", "--batch_evaluate", type=int, default=2048)
                        #20000
    parser.add_argument("-neg", "--num_neg", type=int, default=1, # 10
    ...
    parser.add_argument("-replay_ratio", "--replay_ratio", type=float, default=0.0, help='샘플링 사이즈로 쓰자.')
    ...
    parser.add_argument('-sampling_mode', '--reservoir_selection', type=str, default='',
                        choices=['', 'uniform', 'boosting_inner_product', 'inverse_deg', 'prop_deg', 'latest',
                                 'boosting_wasserstein', 'mse_distill_score', 'adp_inverse_deg', 'item_embedding', 'BPS'])
    ...
    # ablation mode, 1, 2
    parser.add_argument("-ablation_mode", "--ablation_mode", type=int, default=0)
